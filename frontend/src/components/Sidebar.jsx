...
import RegionKPIPanel from './RegionKPIPanel';
...
export default function Sidebar() {
  ...
  return (
    <aside className="flex flex-col h-full overflow-y-auto gap-4 pr-1">
      ...
      {/* Regional Insights & KPIs */}
      {results && (
        <div className="glass-card p-4">
          <div className="flex items-center gap-2 mb-3">
            <Trophy size={14} className="text-amber" />
            <h3 className="text-xs font-bold text-slate-300 uppercase tracking-wider">Regional Intelligence</h3>
          </div>
          <RegionKPIPanel />
        </div>
      )}
